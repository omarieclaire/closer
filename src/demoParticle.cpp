...
//------------------------------------------------------------------
demoParticle::demoParticle(ofPoint aPoint){
	attractPoints = NULL;
    attractPt = aPoint;
...
//------------------------------------------------------------------
void demoParticle::setAttractPoint(ofPoint newAttractPt) {
    attractPt = newAttractPt;
}

//------------------------------------------------------------------
void demoParticle::setColour(int red, int green, int blue) {
    colourRed = red;
    colourGreen = green;
    colourBlue = blue;
}
...
void demoParticle::update(){
	...
	if( mode == PARTICLE_MODE_ATTRACT ){
        ...
        // We updated this code to use attractPt that belongs to the
        // demoParticle class. Previously, it just used the mouse
        // coordinates.
...
void demoParticle::draw(){
	...
	if( mode == PARTICLE_MODE_ATTRACT ){
		ofSetColor(colourRed, colourGreen, colourBlue);
	}
	else if( mode == PARTICLE_MODE_REPEL ){
